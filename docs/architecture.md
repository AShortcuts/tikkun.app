...
- Informational About, Privacy, Support, public Settings/diagnostics, and Tidbits pages and their exclusive route bundles are also deferred, along with the decorative public-site background. Their online routes remain available. Reading Index keeps its shared public layout; Reader Settings is a separate core offline feature.
